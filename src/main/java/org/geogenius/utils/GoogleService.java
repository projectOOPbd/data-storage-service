...
public class GoogleService {
    ...
    public static void uploadImageToDrive(java.io.File imageFile) {
    ...
    public static void downloadImageToDrive(String imageID) {
        try {
    ...
    public static void deleteImageFromDrive(String imageID) {
        try {
            if (imageID == null || imageID.isEmpty()) {
                System.out.println("Неправильний ID файлу: " + imageID);
                return;
            ...
            e.printStackTrace(); // Виводить стектрейс помилки
            throw new RuntimeException("Помилка при видаленні файлу з Google Диска. ID: " + imageID, e);
        }
    }
